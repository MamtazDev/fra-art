    ...
    <>
      <div className="sidebar">
        <div className="brand-logo">
          <Link to="/admin/" className="full-logo">
        ...
        <div className="menu">
          <ul>
            ...
            <li className={location == "/admin/wallet" ? "active" : ""}>
            ...
            <li className={location == "/admin/profile" ? "active" : ""}>
            ...
            <li className={location == "/admin/signin" ? "active" : " logout"}>
