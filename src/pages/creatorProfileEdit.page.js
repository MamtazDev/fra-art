...
import { bg1, client01 } from "../utils/images.util";

const CreatorProfileEdit = () => {
  const [name, setName] = useState("fraart");
  const [url, setUrl] = useState("https://fraart.netlify.app/");
  const [twitter, _twitter] = useState("https://fraart.netlify.app/");
  const [website, setWebsite] = useState("https://fraart.netlify.app/");
  const [email, setEmail] = useState("fraart@example.com");
