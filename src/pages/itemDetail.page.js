                    ...
                    <div className="tab-content mt-4 pt-2" id="myTabContent">
                      ...
                      >
                        <p className="text-muted">
                          ...
                          NFT website called FraArt (with crypto payment)! What
                          do you think?
                        </p>
                        <p className="text-muted">
                        ...
                        <div className="creators creator-primary d-flex align-items-center">
                          ...
                          <div className="ms-3">
                            <h6 className="mb-0">
                              <a href="/" className="text-dark name">
                                PandaOne
                              </a>
                            </h6>
                          </div>
            ...
            <div className="col">
              <div className="section-title text-center mb-4 pb-2">
                ...
                <p className="text-muted para-desc mb-0 mx-auto">
                  ...
                  artists of all FraArt with their fans and unique token
                  collectors!
                </p>
              </div>
            </div>
                ...
                <div className="col mt-4 pt-2" key={data?.title}>
                  <div className="card nft-items nft-primary nft-auction rounded-md shadow overflow-hidden mb-1 p-3">
                    ...
                    <div className="card-body content position-relative p-0 mt-3">
                      <Link to="/item-details" className="title text-dark h6">
                        {data?.title}
                      </Link>
